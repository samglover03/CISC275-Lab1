...
let oneExcite : String = "I am excited to learn about HTML and CSS";
let anyConcerns : String = "I am nervous about the final project";
let funFact : String = "I have 2 pugs named Rocky and Payton";
